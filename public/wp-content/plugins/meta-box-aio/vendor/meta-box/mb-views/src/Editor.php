...
class Editor {
		...
		$meta_boxes[] = [
			...
			'fields'     => [
				[
					...
					'desc'     => wp_kses_post( sprintf( __( 'Supports any HTML/CSS/JS and shortcodes. Use %s to write conditions, loops and more. To run a PHP function, use <code>mb.function_name(param)</code>.', 'mb-views' ), '<a href="https://twig.symfony.com/doc/1.x/templates.html" target="_blank">Twig</a>' ) )
				],
			],
		];
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'mb-views', MBV_URL . 'assets/views.js', ['jquery', 'code-editor', 'underscore', 'wp-element'], MBV_VER, true );
