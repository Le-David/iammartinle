			...
			'fields'     => [
				[
					...
					'options' => [
						...
						'action'   => __( 'Hook (action)', 'mb-views' ),
						'custom'   => __( 'Custom (via shortcode)', 'mb-views' ),
				...
				[
					...
					'id'                => 'code',                                                                                                                                                                                                                                                               // Add prefix because 'action' is a reserved WordPress param.
					'type'              => 'textarea',
					'sanitize_callback' => 'none',
					'desc'              => sprintf( __( 'Use <a href="%s" target="_blank">conditional tags</a> or any general PHP code to define the rules where the view is rendered. Do not wrap the code in opening and closing PHP tags.', 'mb-views' ), 'https://codex.wordpress.org/Conditional_Tags' ),
					'visible'           => ['type', 'code'],
				],
				[
